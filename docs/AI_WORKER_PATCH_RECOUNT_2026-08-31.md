...
This fix is combined with the single-launch Worker hardening on the post-#582 `main`, reducing duplicate Heavy validation. Earlier #591 validation is historical only.
