...
This fix is combined with the single-launch Worker hardening on the post-#592 current main, reducing duplicate Heavy validation. Earlier #591/#593 validation is historical only.
