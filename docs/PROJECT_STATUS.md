...
- **Quick FollowUp Widget:** عنوان کار + آخرین پیگیری + تاریخ + ساعت؛ بدون Reminder بعدی و بدون Storage جدا.
...
6. **Widget:** تکمیل Widget اصلی و **Quick FollowUp Widget** روی همان source of truth، شامل بررسی Lock Screen.
7. **PDF + Print**
8. **IranSans**
