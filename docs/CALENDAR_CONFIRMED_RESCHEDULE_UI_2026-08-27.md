...
## Merge gate
Rebuilt directly from post-#317 main. Require exact-head Parallel first, then full Build/APK/Device before merge and post-merge main validation before any scorecard stage-85 promotion.
