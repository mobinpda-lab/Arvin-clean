...
- task edit now preserves unrelated canonical fields such as category, checklist, reminder, completion/archive/trash state, recurrence and people references instead of rebuilding a lossy partial Task;
...
- compact Add FollowUp surface with system date/time and blank -> `پیگیری`;
