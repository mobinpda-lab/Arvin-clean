...
Issue: #595
Parent work: #348 / #516
Settings UI lane: #592 (merged on main `6dcb368db8565018384c4a6fb7aad9be22ea9e8c`)

Replayed on current main after #592 → Draft exact-head Fast → Build/APK + Device → Production Orchestrator.
