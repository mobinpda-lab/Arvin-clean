...
class TaskReportPdfRenderer {
  ...
  /// Renders the canonical WorkAgenda through the same PDF engine used by the
  /// existing Task report. Day grouping and scheduling reasons come from
  /// WorkAgendaReportAdapter; Task payload stays owned by TaskReportProjection.
  ...
  pw.Widget _agendaEntry(
    WorkAgendaReportItem item,
