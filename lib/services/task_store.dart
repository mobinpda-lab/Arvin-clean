...
class TaskStore {
  ...
  // SharedPreferencesAsync avoids a per-engine cached view, while the
  // explicit Android backend keeps the canonical key on the existing
  // SharedPreferences store instead of creating a second DataStore.
