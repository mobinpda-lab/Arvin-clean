...
void main() {
  ...
  test('Parallel Wave runs Fast for Draft PRs and skips duplicate Ready work', () {
    ...
    expect(parallel, contains('Arvin Build owns the complete Analyze + sharded Test + Debug/Release APK gate'));
    expect(parallel, contains('Arvin Device Smoke owns real Android integration evidence for Ready PRs'));
  });
}
